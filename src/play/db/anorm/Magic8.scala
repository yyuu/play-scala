...
package anorm {
    ...
    trait MParser8[ A1, A2, A3, A4, A5, A6, A7, A8, R] extends ParserWithId[R] {
        ...
        val columnNames:(String, String, String, String, String, String, String, String)

        lazy val (name1 ,name2 ,name3 ,name4 ,name5 ,name6 ,name7 ,name8) = columnNames
        ...
        override def apply(input:Input):SqlParser.ParseResult[R] = 
            (
             ...
             get[A6](name6)(p6) ~< 
             get[A7](name7)(p7) ~< 
             get[A8](name8)(p8) ^^ { case a1 ~ a2 ~ a3 ~ a4 ~ a5 ~ a6 ~ a7 ~ a8 => apply(a1, a2, a3, a4, a5, a6, a7, a8)} )(input)

        val uniqueId : (Row=> MayErr[SqlRequestError,Any]) = null
    }

        trait M8[ A1, A2, A3, A4, A5, A6, A7, A8, R] {
            self: MParser8[ A1, A2, A3, A4, A5, A6, A7, A8,R] =>
            ...
            def update(v:R)(implicit hasId: (A1 <:< Pk[_])|:|(A2 <:< Pk[_])|:|(A3 <:< Pk[_])|:|(A4 <:< Pk[_])|:|(A5 <:< Pk[_])|:|(A6 <:< Pk[_])|:|(A7 <:< Pk[_])|:|(A8 <:< Pk[_]) ) = {

                val all = ((v,hasId) match {
                        case (self( a1, a2, a3, a4, a5, a6, a7, a8), ( e1 |:| e2 |:| e3 |:| e4 |:| e5 |:| e6 |:| e7 |:| e8)) => 
                            List ( 
           ...
           def create(v:R)(implicit hasId: (A1 <:< Pk[_])|:|(A2 <:< Pk[_])|:|(A3 <:< Pk[_])|:|(A4 <:< Pk[_])|:|(A5 <:< Pk[_])|:|(A6 <:< Pk[_])|:|(A7 <:< Pk[_])|:|(A8 <:< Pk[_]) ) :R = {
                ...
                val List( a1, a2, a3, a4, a5, a6, a7, a8) = all.map(_._3.aValue).map({case NotAssigned => Id(id); case other => other})
                apply(a1.asInstanceOf[A1], a2.asInstanceOf[A2], a3.asInstanceOf[A3], a4.asInstanceOf[A4], a5.asInstanceOf[A5], a6.asInstanceOf[A6], a7.asInstanceOf[A7], a8.asInstanceOf[A8])
