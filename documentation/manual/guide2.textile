...
There are several way to use *Anorm*, depending of your need. In this tutorial we will use the most advanced one where we will automatically map the result of our SQL queries to a set of *case class* representing our data.
...
Finally, we will add an helper method to the **Comment** object to simplify adding comments:
