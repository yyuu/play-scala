...
As you see, this User *case class* matches our User table definition; and it will help us to parse the result of our SQL queries involving the User table.
...
Actually, because the **data.yml** file is a little big, you can "download it here":files/data.yml.
