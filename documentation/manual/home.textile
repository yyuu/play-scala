...
### "Using plain old SQL requests":database#UsingplainoldSQLrequests
...
# "SQL data access with Play Scala":sql
## "Overview":sql#Overview
## "Executing SQL requests":sql#ExecutingSQLrequests
## "Retrieving data using the Stream API":sql#RetrievingdatausingtheStreamAPI
## "Using Pattern Matching":sql#UsingPatternMatching
## "Dealing with Nullable columns":sql#DealingwithNullablecolumns
## "Using the Parser combinator API":sql#UsingtheParsercombinatorAPI
## "Adding some Magic[T]":sql#AddingsomeMagicT
