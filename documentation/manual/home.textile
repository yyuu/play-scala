...
Welcome to the Play Scala documentation. This documentation is intended for the **0.9.1 release** of the Scala module and may differ significantly from previous versions. 
...
p(note). This version is still in beta but can already be used to create complete Play applications using Scala as main language. Most of the API is stabilized and future versions will just improve compatibility with existing Play features.
...
The Scala version of Play framework uses the same philosophy and concepts as the Java version. Here are the Scala specific features deeply explained.
...
## "Template parameters":templates#Templateparameters
