...
bc. def index = renderHtml("Hello scala!")
...
As shown above, for simple action methods you can directly write to the response object. For example using a String:

bc. def index = renderHtml("<h1>Hello world</h1>")
...
bc. def index(name: String = "Guest") = renderHtml(<h1>Hello {name}</h1>)
...
object Application extends Controller with Secure {
  def index = renderHtml ("Hello world")
}
